...
echo "Downloading binary file: https://github.com/v2fly/v2ray-core/releases/download/${TAG}/${V2RAY_FILE}"
echo "Downloading binary file: https://github.com/v2fly/v2ray-core/releases/download/${TAG}/${DGST_FILE}"
